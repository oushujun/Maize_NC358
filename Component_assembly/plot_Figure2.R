...
repeats_p = repeats %>% 
  ...
  ggplot(aes(x = Lines, y = value, fill = variable)) + 
  ...
  theme(legend.position="top") +
  scale_x_discrete(limits=ID) + 
#  scale_x_discrete(labels=c("NC358_11k_50x" = "11k 50x", "NC358_16k_50x" = "16k 50x", "NC358_21k_20x" = "21k 20x","NC358_21k_30x" = "21k 30x","NC358_21k_40x" = "21k 40x","NC358_21k_50x" = "21k 50x","NC358_21k_60x" = "21k 60x","NC358_21k_75x" = "21k 75x")) +
  theme(strip.text.x = element_text(size = 17))
...
ps = c(repeats_p, Fra_all_p, telomere_p, cent_chip_p, centC_p, NOR_p, gene_p, knobs_p)
